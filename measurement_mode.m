...
% Check match quality
         ...
         %[Lidar_x_test,Lidar_y_test,rotation_test] = calc_Lidar_location_w_displ(Lidar_trace,rotation_trace,reflect_pool_xy,reflect_pool_ID,detected_pool_polar,detected_pool_ID,dist_err,angle_err) 
